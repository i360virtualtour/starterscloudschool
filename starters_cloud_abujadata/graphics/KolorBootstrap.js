...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'starters_cloud_abujadata/starters_cloud_abuja_messages_','.xml');
	krpanoLoaded = true;
...
addKolorSocial('socialButton2','google');
addKolorSocial('socialButton1','twitter');
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'starters_cloud_abujadata/starters_cloud_abuja_messages_','.xml');
}
...
function addKolorSocial(pPlugID, vendorID)
{
	...
	{
		var kolorSocialJS = new ktools.Script("KolorSocialJS", crossDomainTargetUrl+"starters_cloud_abujadata/graphics/KolorSocial/KolorSocial.min.js", [], true);
...
function addKolorBox(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"starters_cloud_abujadata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"starters_cloud_abujadata/graphics/KolorBox/KolorBox.min.js", [], true);
...
function addKolorArea(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"starters_cloud_abujadata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"starters_cloud_abujadata/graphics/KolorArea/KolorArea.min.js", [], true);
